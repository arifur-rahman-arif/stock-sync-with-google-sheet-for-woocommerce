  ...
  var Dashboard = /*#__PURE__*/function () {
    ...
    _createClass(Dashboard, [{
      ...
      value: function events() {
        ...
        this.settingsInput.on("input", this.handleNavigationButton); // this.modalNextButton.on("click", this.showNextModal.bind(this));
      ...
      value: function handleNavigationButton() {
        ...
        if (!sheetUrl || !tabName) {
          $(".btn.sw-btn-next").addClass("wsmgs_inactive").attr("title", "Please fill up all input fields").attr("original-title", "Please fill up all input fields").attr("data-bs-toggle", "tooltip").attr("data-bs-placement", "bottom");
          ...
          var _tooltip = bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip.getInstance($(".wsmgs_inactive"));
        ...
        try {
          $.ajax({
            ...
            complete: function complete() {
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.closeLoadingButton)(target, "Next");
        ...
        try {
          $.ajax({
            ...
            success: function success(response) {
              ...
              _this.optionSaved = true;

              _this.smartWizard.smartWizard("stepState", [1], "enable");
