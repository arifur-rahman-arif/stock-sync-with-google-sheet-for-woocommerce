    ...
    _createClass(Dashboard, [{
      ...
      value: function events() {
        ...
        this.botCopyBtn.on("click", function (e) {
          var target = $(e.currentTarget);
          var text = target.parent().find("code").text().trim();
          (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.copyToClipboard)(text);
        });
        this.settingsInput.on("input", this.handleNavigationButton.bind(this)); // this.modalNextButton.on("click", this.showNextModal.bind(this));
      ...
      value: function callMethods() {
        ...
        new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_tooltip_element1"), {
          html: true
        });
        new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_tooltip_element2"), {
          html: true
        });
        new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_tooltip_element3"), {
          html: true
        });
      ...
      key: "showNextModal",
      value: function showNextModal(e) {
        var target = $(e.currentTarget);
        ...
        $(target.parents(".modal")).modal("hide");
        var modal = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal($(target.attr("data-bs-target")));
        modal.show();
      } // Go back to the previous modal

    }, {
      key: "showPrevModal",
      value: function showPrevModal(e) {
        var target = $(e.currentTarget);
        $(target.parents(".modal")).modal("hide");
        var modal = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal($(target.attr("data-bs-target")));
        modal.show();
      ...
      key: "doesBotHasEditorAccees",
      value: function doesBotHasEditorAccees(e) {
        var _this = this;
