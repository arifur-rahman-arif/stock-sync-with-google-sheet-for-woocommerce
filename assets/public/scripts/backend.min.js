...
$(function () {
  var Dashboard = /*#__PURE__*/function () {
    function Dashboard() {
      ...
      this.gaveEditorAccess = $("#gave_editor_access"); // Properties of this class
    ...
    _createClass(Dashboard, [{
      ...
      value: function callMethods() {
        ...
        $(".wsmgs_tooltip_element1").length && new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_tooltip_element1"), {
          html: true
        });
        $(".wsmgs_tooltip_element2").length && new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_tooltip_element2"), {
          html: true
        });
        $(".wsmgs_tooltip_element3").length && new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_tooltip_element3"), {
          html: true
        });
        $(".wsmgs_tooltip_element4").length && new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_tooltip_element4"), {
          html: true
        });
      ...
      value: function handleNavigationButton() {
        ...
        if (!sheetUrl || !tabName) {
          $(".btn.sw-btn-next").addClass("wsmgs_inactive").attr("title", "Please fill up all input fields").attr("original-title", "Please fill up all input fields").attr("data-bs-toggle", "tooltip").attr("data-bs-placement", "left");
          $(".wsmgs_inactive").length && new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_inactive"));
        } else {
        ...
        try {
          $.ajax({
            ...
            success: function success(response) {
              ...
              $(".btn.sw-btn-next").addClass("wsmgs_inactive").attr("title", "Please give this ID editor access in your sheet").attr("data-bs-toggle", "tooltip").attr("data-bs-placement", "left");
      ...
      key: "showWizard",
      value: function showWizard(e) {} // Enable or disable the next button upon changing of gave editor access checkbox
      ...
      value: function checkNextButton(e) {
        ...
        if ($(e.currentTarget).prop("checked")) {
          ...
          $(".btn.sw-btn-next").attr("title", "Please give this ID editor access in your sheet").attr("data-bs-toggle", "tooltip").attr("data-bs-placement", "left");
          new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_inactive"));
        }
      ...
      key: "appScriptCode",
      value: function appScriptCode(args) {
