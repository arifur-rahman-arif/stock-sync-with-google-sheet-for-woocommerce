...
/***/ "./assets/src/scripts/modules/backend/dashboard.js":
/*!*********************************************************!*\
  !*** ./assets/src/scripts/modules/backend/dashboard.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/helper-functions */ "./assets/src/scripts/modules/utils/helper-functions.js");
...
$(function () {
  var Dashboard = /*#__PURE__*/function () {
    function Dashboard() {
      ...
      this.syncButton = $(".sync_button"); // Properties of this class
    ...
    _createClass(Dashboard, [{
      ...
      value: function events() {
        this.botMail.on("click", function (e) {
          var target = $(e.currentTarget);
          var text = target.text().trim();
          (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.copyToClipboard)(text);
        });
        this.botCopyBtn.on("click", function (e) {
          var target = $(e.currentTarget);
          var text = target.parent().find(".bot_mail code").text().trim();
          (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.copyToClipboard)(text);
        });
      ...
      value: function callMethods() {
        ...
        var tooltips = $(".wsmgs_tooltip_element");
        tooltips.length && $.each(tooltips, function (i, element) {
          new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(element), {
            html: true
          });
        ...
        this.smartWizard.length && this.smartWizard.smartWizard({
          selected: 0,
      ...
      key: "handleNavigationButton",
      value: function handleNavigationButton() {
        var sheetUrl = $(".modal_sheet_url").val();
        var tabName = $(".modal_tab_name").val();
        this.smartWizard.length && this.smartWizard.smartWizard("stepState", [1, 2, 3], "disable");
        this.optionSaved = false;
        this.hasEditorAccess = false;
        ...
        if (!sheetUrl || !tabName) {
          this.setTheTooltip({
            title: "Please fill up all input fields"
          });
        } else {
          if (!$(".btn.sw-btn-next").hasClass("wsmgs_inactive")) return;
          var tooltip = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_inactive"), {
            html: true
          });
          tooltip.dispose();
      ...
      value: function checkRequiredFields() {
        ...
        if ((0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.getURLHashValue)() !== "#step-1") return false;
        var sheetUrl = $(".modal_sheet_url").val();
        var tabName = $(".modal_tab_name").val(); // If sheet url or tab name value dont exits than show warning

        if (!sheetUrl || !tabName) {
          (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showAlert)({
        ...
        var validUrl = (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.isValidHttpUrl)(sheetUrl);
      ...
      key: "doesBotHasEditorAccess",
      value: function doesBotHasEditorAccess(e) {
        var _this = this;

        var target = $(e.currentTarget); // If its not the first step than return false

        if ((0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.getURLHashValue)() !== "#step-2") return false;
        ...
        try {
          $.ajax({
            ...
            beforeSend: function beforeSend() {
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showLoadingButton)($(".btn.sw-btn-next"));
            ...
            success: function success(response) {
              ...
              _this.smartWizard.smartWizard("stepState", [2], "enable");

              _this.smartWizard.smartWizard("next");

              _this.hasEditorAccess = true;

              _this.setTheTooltip({
                title: "Are you sure you have pasted Script Code correctly?"
              });
            },
            complete: function complete() {
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.closeLoadingButton)($(".btn.sw-btn-next"), "Next");
            ...
            error: function error(_error) {
              ...
              _this.gaveEditorAccess.prop("checked", false);
            }
          });
        } catch (error) {
          (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showAlert)({
      ...
      key: "saveOptionsValue",
      value: function saveOptionsValue(e, anchorObject, currentStepIndex, nextStepIndex, stepDirection) {
        var _this2 = this;
        ...
        try {
          $.ajax({
            ...
            success: function success(response) {
              ...
              _this2.optionSaved = true;

              _this2.smartWizard.smartWizard("stepState", [1], "enable");

              _this2.smartWizard.smartWizard("next");

              _this2.setTheTooltip({
                title: "Please give this ID editor access in your sheet"
              });
            },
            complete: function complete() {
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.closeLoadingButton)($(".btn.sw-btn-next"), "Next");
            ...
            error: function error(_error2) {
              var response = _error2.responseJSON;
              var message = response.data.message;
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showAlert)({
                message: message,
                type: "alert_error"
      ...
      key: "checkNextButton",
      value: function checkNextButton(e) {
        var nextBtn = $(".btn.sw-btn-next");
      ...
      key: "activateStep4",
      value: function activateStep4(e) {
        var nextBtn = $(".btn.sw-btn-next");
      ...
      key: "copyScriptCode",
      value: function copyScriptCode(e) {
        var _this3 = this;
        ...
        try {
          $.ajax({
            ...
            beforeSend: function beforeSend() {
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showLoadingButton)(target);
              target.attr("disabled", true).addClass("wsmgs_inactive");
            },
            success: function success(response) {
              var text = response.data.scriptCode;
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.copyToClipboard)(text);
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showAlert)({
                message: response.data.message,
                type: "alert_success"
              });
              _this3.smartWizard.length && _this3.smartWizard.smartWizard("stepState", [3], "enable");
            },
            complete: function complete() {
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.closeLoadingButton)(target, "Copy Script");
              target.attr("disabled", false).removeClass("wsmgs_inactive");
            },
            error: function error(_error3) {
              var response = _error3.responseJSON;
              var message = response.data.message;
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showAlert)({
                message: message,
                type: "alert_error"
      ...
      key: "setTheTooltip",
      value: function setTheTooltip(args) {
        var title = args.title;
        $(".btn.sw-btn-next").addClass("wsmgs_inactive").attr("title", title).attr("data-bs-toggle", "tooltip").attr("data-bs-placement", "left");
        $(".btn.sw-btn-next").length && new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_inactive"));
      } // Export all WordPress products to google sheet

    }, {
      key: "exportProducts",
      value: function exportProducts(e) {
        var _this4 = this;

        var target = $(e.currentTarget); // Send ajax request to server for user authentication
        ...
        $.ajax({
          ...
          success: function success(response) {
            try {
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showAlert)({
                message: response.data.message,
                type: "alert_".concat(response.data.status)
              });
          ...
          complete: function complete() {
            (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.closeLoadingButton)(target, "Sync with Google Sheet");
            target.attr("disabled", false).removeClass("wsmgs_inactive");
          },
          error: function error(_error4) {
            var response = JSON.parse(_error4.responseText);
            (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showAlert)({
              message: response.data.message,
              type: "alert_".concat(response.data.status)
            });
      ...
      key: "redirectUser",
      value: function redirectUser(e) {
        if ((0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.getURLHashValue)() !== "step-4") return false;
        var target = $(e.currentTarget);
        ...
        try {
          $.ajax({
            ...
            complete: function complete() {
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.closeLoadingButton)(target, "Done");
              target.attr("disabled", false).removeClass("wsmgs_inactive");
            },
            error: function error(_error5) {
              var response = _error5.responseJSON;
              var message = response.data.message;
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showAlert)({
                message: message,
                type: "alert_error"
      ...
      key: "handleNextButtonStyle",
      value: function handleNextButtonStyle() {
        this.gaveEditorAccess.prop("checked", false);
        this.pastedAppScript.prop("checked", false);
...
/***/ "./assets/src/scripts/modules/utils/export-button.js":
/*!***********************************************************!*\
  !*** ./assets/src/scripts/modules/utils/export-button.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helper_functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helper-functions */ "./assets/src/scripts/modules/utils/helper-functions.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
  ...
  var AuthButton = /*#__PURE__*/function () {
    ...
    _createClass(AuthButton, [{
      ...
      value: function events() {
        ...
        $(document).on("click", ".wsmgs_export_btn", function (e) {
          e.preventDefault();

          _this.exportProducts(e);
        });
      }
    }, {
      key: "callMethods",
      ...
      value: function exportProducts(e) {
        ...
        $.ajax({
          ...
          beforeSend: function beforeSend() {
            ...
            (0,_helper_functions__WEBPACK_IMPORTED_MODULE_0__.showLoader)();
          },
          success: function success(response) {
            try {
              (0,_helper_functions__WEBPACK_IMPORTED_MODULE_0__.showAlert)({
                message: response.data.message,
                type: "alert_".concat(response.data.status)
              });
          ...
          complete: function complete() {
            $(".wsmgs_export_btn").removeClass("wsmgs_disabled");
            $(".wsmgs_export_btn").attr("disabled", false);
            (0,_helper_functions__WEBPACK_IMPORTED_MODULE_0__.closeLoader)();
          },
          error: function error(_error) {
            var response = JSON.parse(_error.responseText);
            (0,_helper_functions__WEBPACK_IMPORTED_MODULE_0__.showAlert)({
              message: response.data.message,
              type: "alert_".concat(response.data.status)
            });
...
/***/ "./assets/src/scripts/modules/utils/helper-functions.js":
/*!**************************************************************!*\
  !*** ./assets/src/scripts/modules/utils/helper-functions.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "showLoadingButton": () => (/* binding */ showLoadingButton),
/* harmony export */   "closeLoadingButton": () => (/* binding */ closeLoadingButton),
/* harmony export */   "getURLHashValue": () => (/* binding */ getURLHashValue)
/* harmony export */ });
/* harmony import */ var bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js");
...
var copyToClipboard = function copyToClipboard(text) {
  if (navigator.clipboard) {
    ...
    var input = document.createElement("input"); // Assign it the value of the specified element

    input.setAttribute("value", text); // Append it to the body

    document.body.appendChild(input); // Highlight its content

    input.select(); // Copy the highlighted text
...
var showAlert = function showAlert(args) {
  var message = args.message,
      type = args.type;
  if (!message || !type) return;
  insertAlertToUi();
  var element = $(".wsmgs_alert");
  var alertTypes = {
  ...
  var toast = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Toast(element);
  toast.show();
};

var insertAlertToUi = function insertAlertToUi() {
...
var showLoadingButton = function showLoadingButton(target) {
  target.addClass("btn-loading");
  target.html("\n        <div class=\"spinner-border text-success\" role=\"status\">\n            <span class=\"sr-only\"></span>\n        </div>\n    ");
}; // Show loading button

var closeLoadingButton = function closeLoadingButton(target, text) {
  target.removeClass("btn-loading");
  if (!text) text = "Default";
  target.html(text);
}; // Get the url hash value from current browser url

var getURLHashValue = function getURLHashValue() {
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[1].use[2]!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[1].use[3]!./assets/src/styles/backend.scss":
/*!***************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[1].use[2]!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[1].use[3]!./assets/src/styles/backend.scss ***!
  \***************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./assets/src/styles/backend.scss":
/*!****************************************!*\
  !*** ./assets/src/styles/backend.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_1_use_2_node_modules_sass_loader_dist_cjs_js_ruleSet_1_rules_1_use_3_backend_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!../../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[1].use[2]!../../../node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[1].use[3]!./backend.scss */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[1].use[2]!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[1].use[3]!./assets/src/styles/backend.scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_1_use_2_node_modules_sass_loader_dist_cjs_js_ruleSet_1_rules_1_use_3_backend_scss__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_1_use_2_node_modules_sass_loader_dist_cjs_js_ruleSet_1_rules_1_use_3_backend_scss__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_1_use_2_node_modules_sass_loader_dist_cjs_js_ruleSet_1_rules_1_use_3_backend_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_1_use_2_node_modules_sass_loader_dist_cjs_js_ruleSet_1_rules_1_use_3_backend_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
(() => {
/*!***************************************!*\
  !*** ./assets/src/scripts/backend.js ***!
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _styles_backend_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../styles/backend.scss */ "./assets/src/styles/backend.scss");
/* harmony import */ var _modules_utils_export_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/utils/export-button */ "./assets/src/scripts/modules/utils/export-button.js");
/* harmony import */ var _modules_backend_dashboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/backend/dashboard */ "./assets/src/scripts/modules/backend/dashboard.js");
