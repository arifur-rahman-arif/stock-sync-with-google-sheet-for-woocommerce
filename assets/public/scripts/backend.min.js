  ...
  var AuthButton = /*#__PURE__*/function () {
    ...
    _createClass(AuthButton, [{
      ...
      value: function events() {
        ...
        $(document).on("click", ".wsmgs_authenticate", function (e) {
          e.preventDefault();
