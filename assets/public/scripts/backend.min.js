...
$(function () {
  var Dashboard = /*#__PURE__*/function () {
    ...
    _createClass(Dashboard, [{
      ...
      value: function saveOptionsValue(e) {
        try {
          $.ajax({
            type: "POST",
            url: wsmgsLocal.ajaxUrl,
            ...
            beforeSend: function beforeSend() {
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showLoadingButton)($(e.currentTarget));
            ...
            complete: function complete() {
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.closeLoadingButton)($(e.currentTarget), "Next");
              $(e.currentTarget).attr("disabled", false);
            },
            error: function error(_error2) {
              var response = _error2.responseJSON;
              var message = JSON.parse(response.data.message).error.message + ". Please give bot ID editor access first";
              (0,_utils_helper_functions__WEBPACK_IMPORTED_MODULE_1__.showAlert)({
                message: message,
                type: "alert_error"
              });
