...
<div class="wsmgs_description">
    ...
    <div class="bot_id_container">
        ...
        <button class="bot_copy_btn wsmgs_tooltip_element" data-bs-toggle="tooltip" data-bs-placement="top" title="
    ...
    <div class="script_code_container">
        ...
        <button class="script_copy_btn wsmgs_tooltip_element" data-bs-toggle="tooltip" data-bs-placement="top" title="
                    <div class='tooltip_image_container'>
                    <p>
                        Copy your Google Sheet URL & paste it below to get access your products into it
                    </p>
