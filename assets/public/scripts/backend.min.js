  ...
  var Dashboard = /*#__PURE__*/function () {
    ...
    _createClass(Dashboard, [{
      ...
      value: function callMethods() {
        this.handleNavigationButton(); // Initiate all tooltip
      ...
      value: function handleNavigationButton() {
        ...
        if (!sheetUrl || !tabName) {
          ...
          var tooltip = bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip.getInstance($(".wsmgs_inactive"));
          tooltip.dispose();
      ...
      value: function setTheTooltip(args) {
        ...
        new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip($(".wsmgs_inactive"));
